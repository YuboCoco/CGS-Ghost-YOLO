...
class StemBlock(nn.Module):
    def __init__(self,c1,c2,k=3,s=2,p=None,g=1,act = True) :
        ...
        self.stem_1 = Conv(c1,c2,3,1,1,g,act)
...
class SMU(nn.Module):
    ...
    def __init__(self, alpha = 0.25, mu=1):
...
def GroupNorm(num_features, num_groups=4,eps=1e-5,affine=True, *args, **kwargs):
...
class SPPF(nn.Module):
    ...
    def __init__(self, c1, c2, k=5):  # equivalent to SPP(k=(5, 9, 13))
        ...
        #self.m1 = [nn.MaxPool2d(kernel_size=k, stride=1, padding=k // 2),
         #                         antialiased_cnns.BlurPool(c_, stride=1)]
        #self.m2 = [nn.MaxPool2d(kernel_size=k, stride=1, padding=k // 2),
         #                         antialiased_cnns.BlurPool(c2, stride=1)]
